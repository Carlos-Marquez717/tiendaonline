<template>
    ...
    <header class="z-10 py-4 bg-black shadow-md">
        ...
        <div class="container flex justify-between items-center px-6 mx-auto h-full text-white md:justify-end">
            ...
            <!-- Agregar el enlace del carrito aquí -->
            <NavLink :href="route('cart.index')" :active="route().current('cart.index')">
                <template #icon>
                    <svg class="w-12 h-12" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round"
